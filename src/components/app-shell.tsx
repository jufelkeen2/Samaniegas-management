...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen bg-[var(--canvas)] text-[var(--ink)]">
    ...
    <aside className="fixed inset-y-0 left-0 z-30 hidden w-60 border-r border-[var(--line)] bg-white lg:flex lg:flex-col">
      ...
      <div className="m-4 mt-2 rounded-md border border-amber-200 bg-amber-50 p-3 text-xs leading-relaxed text-amber-900">Modo demostración<br /><span className="text-amber-700">Los registros incluidos son ficticios.</span></div>
    </aside>
