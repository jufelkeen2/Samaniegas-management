...
import { CalendarDays, MapPin, Pencil, Phone, Plus, Search, Trash2, Users } from "lucide-react";
...
export default function ClientsPage() {
  ...
  return <>
    <PageHeader title="Clientes" description={`${clients.length} registros visibles · datos de demostración editables`} action={<button className="btn-primary" onClick={() => { setEditing("new"); setError(""); }}><Plus size={17} />Nuevo cliente</button>} />
